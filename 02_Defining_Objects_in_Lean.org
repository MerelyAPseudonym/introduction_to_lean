...
mul : Π {α : Type u_1} [_inst_1 : has_mul α], α → α → α
def mul : Π {α : Type u} [_inst_1 : has_mul α], α → α → α :=
λ {α : Type u} [_inst_1 : has_mul α], has_mul.mul
append : Π {α : Type u_1} [_inst_1 : has_append α], α → α → α
def append : Π {α : Type u} [_inst_1 : has_append α], α → α → α :=
λ {α : Type u} [_inst_1 : has_append α], has_append.append
#+end_example
...
#+RESULTS:
: binary_tree.empty : binary_tree
: binary_tree.cons binary_tree.empty binary_tree.empty : binary_tree
...
#+RESULTS:
: cons empty (cons (cons empty empty) empty) : binary_tree
